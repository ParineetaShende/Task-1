                        ...
                        while (true) {
                            ...
                            if (guess > randomNumber) {
                                System.out.println("The number" + guess
                                        + "is HIGHER than generate Number.you have to guess again...");

                            } else if (guess < randomNumber) {
                                System.out.println("The number" + guess
                                        + "is LOWER than generate Number.you have to guess again...");
                            } else {
                                System.out.println("The number" + guess + "is EQUAL to than Generate Number.\nCongrats it took you" +
                                        "count" + "attempts.");
                                break whileloop;
                            }
                            count++;
